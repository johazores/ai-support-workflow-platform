                  ...
                  <div className="mb-2 flex items-center gap-3">
                    ...
                    <span className="ml-auto flex items-center gap-2 text-xs text-slate-400">
                      {message.externalMessageId && (
                        <span
                          className="inline-flex items-center gap-1 rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-medium text-slate-500 dark:bg-slate-700 dark:text-slate-400"
                          title={`Message-ID: ${message.externalMessageId}`}
                        >
                          <svg
                            className="h-3 w-3"
                            fill="none"
