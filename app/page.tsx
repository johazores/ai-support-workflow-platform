  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-6 py-16">
      <section className="mx-auto max-w-5xl">
        <div className="rounded-3xl bg-white p-10 shadow-lg ring-1 ring-slate-100 md:p-14">
          ...
          <h1 className="mt-6 max-w-3xl text-3xl font-bold tracking-tight text-slate-950 md:text-5xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Link
              href="/login"
              className="rounded-xl bg-slate-950 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-slate-800"
            >
              Sign in to dashboard
            </Link>
            <Link
              href="https://github.com"
              className="rounded-xl px-5 py-2.5 text-sm font-medium text-slate-600 ring-1 ring-slate-200 transition-colors hover:bg-slate-50"
            >
              View on GitHub
            </Link>
          </div>
